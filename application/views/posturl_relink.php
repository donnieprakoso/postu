<div class="sixteen columns">
    ...
    echo "<hr/>";
    ?>
    I'd like to relink this to my stash : 
    <br/>
    <?php
    echo "<ul>";
    for ($i = 0; $i < sizeof($stashes); $i++) {
        ...
        echo "<a href=\"" . site_url("posturl_ops/relinkProcess/" . $link->POST_URL_ID . "/" . $stash->STASH_ID."/".$backDesc) . "\" class=\"people-stash-list\">#" . $stashes[$i]->NAME . "</a>";
        echo "<br/>";
        echo "<br/>";
        echo "<hr/>";
