<body>
    ...
    <div class="container">
        ...
        <br/><br/><br/><hr/>
        <div class="sixteen columns clearfix">
            <div class="ten columns" style="text-align: justify" >
                <h3 style="text-align: center; background-color: white; padding:20px;">Happen to see nice link while you go ? Save it.</h3>

            </div>
            <div class="five columns" style="text-align: justify;" >
                <div><h3 style="color: white;background-color: #457db1;text-align: center;padding:10px;">Mobile Bookmarking</h3></div>
        ...
        <div class="sixteen columns clearfix">        
            <div class="ten columns" style="text-align: justify" >
                <h3 style="text-align: center;background-color: white; padding:20px;">Easy save by Mention or Direct Message</h3>
            </div>
            <div class="five columns" style="text-align: justify" >
                <div><h3 style="color: white;background-color: #457db1;text-align: center;padding:10px;">Hassle Free</h3></div>
        ...
        <div class="sixteen columns clearfix">
            <div class="ten columns" style="text-align: justify" >
                <h3 style="text-align: center;background-color: white; padding:20px;">View your links from any device</h3>
            </div>
            <div class="five columns" style="text-align: justify" >
                <div><h3 style="color: white;background-color: #457db1;text-align: center;padding:10px;">View and Share</h3></div>
